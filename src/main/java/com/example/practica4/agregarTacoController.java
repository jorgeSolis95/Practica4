...
@FXML
    ...
    public void guardado(){
        ...
        alert.setTitle("Se registro El taco");
        alert.setContentText("Se tomo la captura del taco\nPor favor escoga una bebida o \nPase a Orden para pagar");
        alert.showAndWait();
        try {
            ...
            controller.recibirParametrosTacos(id,cantidad,total);
